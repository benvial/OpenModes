...
project = "OpenModes"
copyright = "2012-2017, David Powell"
...
latex_documents = [
    ("index", "OpenModes.tex", "OpenModes Documentation", "David Powell", "manual"),
]
...
man_pages = [("index", "openmodes", "OpenModes Documentation", ["David Powell"], 1)]
